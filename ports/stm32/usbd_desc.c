...
#define USBD_PRODUCT_HS_STRING        "KeyTalent Virtual Comm Port in HS Mode"
#define USBD_PRODUCT_FS_STRING        "KeyTalent Virtual Comm Port in FS Mode"
#define USBD_CONFIGURATION_HS_STRING  "KeyTalent Config"
#define USBD_INTERFACE_HS_STRING      "KeyTalent Interface"
#define USBD_CONFIGURATION_FS_STRING  "KeyTalent Config"
#define USBD_INTERFACE_FS_STRING      "KeyTalent Interface"
