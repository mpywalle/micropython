...
void __flash_led()
{
    HAL_GPIO_TogglePin(BOOTLDR_LED1_PORT, BOOTLDR_LED1_PIN);
    HAL_Delay(50);
    HAL_GPIO_TogglePin(BOOTLDR_LED1_PORT, BOOTLDR_LED1_PIN);
    HAL_Delay(950);
}

void __flash_led_fast()
{
	int round;
	for(round = 0; round <10 ; round ++){
    	HAL_GPIO_WritePin(BOOTLDR_LED3_PORT, BOOTLDR_LED3_PIN, GPIO_PIN_RESET);
    	HAL_Delay(50);
...
void __flash_led_slow()
{
    HAL_GPIO_WritePin(BOOTLDR_LED1_PORT, BOOTLDR_LED1_PIN, GPIO_PIN_RESET);
    HAL_Delay(100);
    HAL_GPIO_WritePin(BOOTLDR_LED1_PORT, BOOTLDR_LED1_PIN, GPIO_PIN_SET);
    HAL_Delay(900);
    HAL_GPIO_WritePin(BOOTLDR_LED2_PORT, BOOTLDR_LED2_PIN, GPIO_PIN_RESET);
    HAL_Delay(100);
